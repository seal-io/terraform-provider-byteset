...
function build() {
  ...
  local ldflags=(
    "-X github.com/seal-io/terraform-provider-byteset/utils/version.Version=${GIT_VERSION}"
    "-X github.com/seal-io/terraform-provider-byteset/utils/version.GitCommit=${GIT_COMMIT}"
    "-w -s"
    "-extldflags '-static'"
  )
