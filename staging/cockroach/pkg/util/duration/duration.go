...
// encoded Durations.
func (d Duration) Encode() (sortNanos, months, days int64, err error) {
...
func (d Duration) EncodeBigInt() (sortNanos *big.Int, months, days int64) {
...
func Decode(sortNanos, months, days int64) (Duration, error) {
...
func Truncate(d, r time.Duration) time.Duration {
	if r == 0 {
