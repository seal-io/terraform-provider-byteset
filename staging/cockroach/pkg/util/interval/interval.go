...
func (overlapper inclusiveOverlapper) Overlap(a, b Range) bool {
	return overlapsInclusive(a, b)
}

func overlapsInclusive(a, b Range) bool {
...
func (overlapper exclusiveOverlapper) Overlap(a, b Range) bool {
	return overlapsExclusive(a, b)
}

func overlapsExclusive(a, b Range) bool {
	return a.Start.Compare(b.End) < 0 && b.Start.Compare(a.End) < 0
}
