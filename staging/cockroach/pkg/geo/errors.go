...
var (
	_ error               = (*EmptyGeometryError)(nil)
	_ errors.SafeDetailer = (*EmptyGeometryError)(nil)
	_ fmt.Formatter       = (*EmptyGeometryError)(nil)
	_ errors.Formatter    = (*EmptyGeometryError)(nil)
)
