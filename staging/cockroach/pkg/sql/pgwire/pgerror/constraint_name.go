...
var (
	_ error                = (*withConstraintName)(nil)
	_ errors.SafeDetailer  = (*withConstraintName)(nil)
	_ fmt.Formatter        = (*withConstraintName)(nil)
	_ errors.SafeFormatter = (*withConstraintName)(nil)
)
