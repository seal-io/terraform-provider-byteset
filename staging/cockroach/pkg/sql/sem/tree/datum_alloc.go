...
const (
	defaultDatumAllocSize = 16    // Arbitrary, could be tuned.
	datumAllocMultiplier  = 4     // Arbitrary, could be tuned.
	defaultEWKBAllocSize  = 4096  // Arbitrary, could be tuned.
	maxEWKBAllocSize      = 16384 // Arbitrary, could be tuned.
)
...
func (a *DatumAlloc) NewDCollatedString(contents, locale string) (*DCollatedString, error) {
