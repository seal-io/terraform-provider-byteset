...
var (
	...
	ErrSqrtOfNegNumber = pgerror.New(
		pgcode.InvalidArgumentForPowerFunction,
...
func AppendToMaybeNullArray(typ *types.T, left, right Datum) (Datum, error) {
...
func PrependToMaybeNullArray(typ *types.T, left, right Datum) (Datum, error) {
	result := NewDArray(typ)
...
func ConcatArrays(typ *types.T, left, right Datum) (Datum, error) {
...
func ArrayContains(ctx CompareContext, haystack, needles *DArray) (*DBool, error) {
