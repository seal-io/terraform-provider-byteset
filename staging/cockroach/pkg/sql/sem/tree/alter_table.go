...
var (
	...
	_ AlterTableCmd = &AlterTableSetOnUpdate{}
	_ AlterTableCmd = &AlterTableSetVisible{}
	_ AlterTableCmd = &AlterTableValidateConstraint{}
	_ AlterTableCmd = &AlterTablePartitionByTable{}
	_ AlterTableCmd = &AlterTableInjectStats{}
	_ AlterTableCmd = &AlterTableSetStorageParams{}
	_ AlterTableCmd = &AlterTableResetStorageParams{}
)
...
// regular table.
func GetTableType(isSequence, isView, isMaterialized bool) string {
	tableType := "table"
	if isSequence {
		tableType = "sequence"
	} else if isView {
