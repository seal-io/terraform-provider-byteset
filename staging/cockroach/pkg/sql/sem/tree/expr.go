...
var (
	...
	_ operatorExpr = &IsNullExpr{}
	_ operatorExpr = &IsNotNullExpr{}
...
var (
	_ Operator = (*UnaryOperator)(nil)
	_ Operator = (*treebin.BinaryOperator)(nil)
	_ Operator = (*treecmp.ComparisonOperator)(nil)
)
...
func (node *CoalesceExpr) GetWhenCondition(i int) (whenCond Expr) {
	...
	_, ok := CmpOps[treecmp.IsNotDistinctFrom].LookupImpl(leftExpr.ResolvedType(), rightExpr.ResolvedType())
...
func NewBinExprIfValidOverload(
	op treebin.BinaryOperator, left, right TypedExpr,
) *BinaryExpr {
